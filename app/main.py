...
app = FastAPI(title="Istanbul Parking API - Unix Socket Production")
...
def get_db():
    ...
    # Cloud Run Unix Soket Bağlantısı Aktifse
    if db_host.startswith("/cloudsql"):
        # psycopg2'nin otomatik ek getirmesini önlemek için güvenli soket parametre ayrımı:
    ...
    # Yerel bilgisayardayken (Normal IP üzerinden)
    return psycopg2.connect(
        dbname=os.getenv("DB_NAME", "parking_db"),
        user=os.getenv("DB_USER", "parking_user"),
        password=db_password,
